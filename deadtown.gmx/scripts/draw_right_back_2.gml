...
draw_rectangle(x_center+ui_info_sx,y_center+ui_info_sy,x_center+ui_info_ex,y_center+ui_info_ey,0)
...
draw_rectangle(x_center+ui_info2_x-bh,y_center+ui_info2_y-bh*2,x_center+ui_info2_x+bh,y_center+ui_info2_y,0)
